...
Peaceful Public License - Personal Version (PPL-Personal) {.unnumbered}
---------------------------------------------------------
...
4. **Authorship Assertion and Perpetuation**:

   **Authorship Assertion**:
   - The license holder may specify how they wish to be identified as the author of this work.
   - This authorship assertion may include a name, pseudonym, organization, or the term **"Anonymous"** if no authorship is asserted.
   - The assertion must be documented in the **Authorship Notice** at the top of this license.

   **Authorship in Derivative Works**:
   - If you create and distribute derivative works, you must **preserve the Authorship Notice** from the original license.
   - This includes any authorship assertion (name, pseudonym, or other identifier) declared by the license holder.
   - The Authorship Notice must remain intact in **all copies, modifications, and derivative works**, and it must be included wherever the license is included, such as source files, documentation, or metadata.
   - If you contribute to a derivative work, you may add your name to the list of **Contributors** in the Authorship Notice.
   - However, you may not modify, remove, or obscure the original Authorship Notice or the name of the original author.
   - Contributors must be listed in a separate, clearly marked section within the Authorship Notice.

   **Prohibition on Removal or Obfuscation**:
   - You may not remove, obscure, or alter the Authorship Notice.
   - The authorship assertion must remain legible and accessible in derivative works.
   - This obligation ensures that the original authorship is preserved and acknowledged throughout the lifetime of derivative works.

   **Definition of Derivative Works**:
   - "Derivative Works" are any adaptations, modifications, translations, extensions, or alterations of the licensed work.
   - This includes, but is not limited to:
     - **Transformed content**:  
     (abridged versions, visual derivatives, translations)
     - **Code or documentation changes**:  
     (modifications in source code, scripts, or explanations)
     - **Repackaged works**:  
     (re-hosted or redistributed files under a new title or brand)
